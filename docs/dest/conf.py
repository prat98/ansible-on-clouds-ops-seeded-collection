...
# TODO patch the original theme
# There's many bugs found when we try to generate the docs from Ansible roles.
# Lists doesn't work, broken special characters escaping, etc.
